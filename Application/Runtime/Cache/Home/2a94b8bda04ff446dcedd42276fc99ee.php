...
<link rel="stylesheet" href="../../../../Public/build/css/layui.css">
...
<a href="<?php echo U('Login/login');?>">点击登录</a>
...
<script src="../../../../Public/build/layui.js" type="text/javascript" charset="utf-8"></script>
<script>



layui.use('layim', function(layim){
	layim.on('user', function(data){
	  console.log(data);
	});
  var autoReplay = [
    '您好，我现在有事不在，一会再和您联系。', 
  ...
  layim.config({
    ...
    //查看群员接口
    ,members: {
      url: '../../../../Public/json/getMembers.json'
      ,data: {}
    }
...
var socket = new WebSocket('ws://127.0.0.1:8000');//服务器改成ip地址加端口号
...
// 				$.post("<?php echo U('bind');?>", {client_id: jmsg.client_id,uid:<?php echo ($_SESSION['uname']); ?>}, function (data) { }); 
// 			} 
		} 
